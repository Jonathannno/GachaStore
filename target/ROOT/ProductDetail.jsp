...
<head>
    ...
    <style>
        @font-face 
        { font-family: 'Aptos SemiBold'; src: local('Aptos SemiBold'), local('Aptos-SemiBold'); }
...
<div class="container">
    ...
    <div class="info">
        ...
        <div class="meta">
            <i class="fa-solid fa-layer-group"></i> <b>Stock:</b> 
            <span style="<%= isOutOfStock ? "color: red;" : "" %>">
        ...
        <form action="cartservlet" method="POST" class="purchase-controls">
            ...
            <% if (isOutOfStock) { %>
                <div class="stock-warning">
                    <i class="fa-solid fa-circle-xmark"></i> Currently Sold Out
                </div>
                <div class="actions">
            ...
            <% } else { %>
                <div class="qty-group">
                    ...
                    <input type="number" id="quantity" name="quantity" class="qty-input" value="1" min="1" max="<%= stock %>">
                </div>
